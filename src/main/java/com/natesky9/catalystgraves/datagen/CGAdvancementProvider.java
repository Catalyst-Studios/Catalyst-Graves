...
public class CGAdvancementProvider implements AdvancementProvider.AdvancementGenerator
{
    ...
    @Override
    public void generate(@SuppressWarnings("null") HolderLookup.Provider provider, @SuppressWarnings("null") Consumer<AdvancementHolder> consumer, @SuppressWarnings("null") ExistingFileHelper existingFileHelper)
    {
